...
public class MainActivity extends AppCompatActivity {
    ...
    private void InboxStyle(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANEL_ID).setSmallIcon(R.drawable.dice1).setContentTitle("InboxStyle").setStyle(new NotificationCompat.InboxStyle().addLine("Linia 1").addLine("Linia 2").addLine("Linia 3")).setPriority(NotificationCompat.PRIORITY_DEFAULT).setAutoCancel(true);
